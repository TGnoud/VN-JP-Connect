...
export default function Input({ label, error, hint, className, type, id, ...props }: InputProps) {
      ...
      <div className="relative">
        <input
          ...
          className={clsx(
            ...
            "focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition-all",
            error
