        ...
        {showFilterChips && (
          <div className="px-5 pb-3 shrink-0 flex flex-wrap gap-2">
            ...
            <button
              ...
              style={
                showBookmarkedOnly
                  ? { backgroundColor: "#854d0e", color: "white" }
                  : { backgroundColor: "white", color: "#374151", border: "1.5px solid #e5e7eb" }
              }
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="size-4" viewBox="0 0 24 24" fill={showBookmarkedOnly ? "white" : "#d97706"} stroke={showBookmarkedOnly ? "white" : "#d97706"} strokeWidth={0.5}>
